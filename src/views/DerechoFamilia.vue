  ...
  <div class="especializacion-page">
    <section class="hero-section">
      <div class="container">
        ...
        <p class="fade-in-up" style="animation-delay: 0.3s;">{{ especializacion.subtitulo }}</p>
      </div>
    </section>
      ...
      <div class="container">
        <div class="page-content">
          ...
          <ul class="services-list">
            <li v-for="(servicio, index) in especializacion.servicios" :key="index"
          ...
          <div class="cta-box animate-on-scroll">
            ...
            <p>Contactanos para una consulta gratuita</p>
...
const especializacion = contenido.especializaciones.find(e => e.id === 'derecho-familia')
